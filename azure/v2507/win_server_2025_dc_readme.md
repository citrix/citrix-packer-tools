# Packer Template For Windows Server 2025 Datacenter
...
"image_name" : prefix of name of the image and snapshot that will be used in capturing image. default value is "win_server_2025_dc" 
...
```shell
> .\packer.exe build .\win_server_2025_dc_packer_template.json
```
