# Packer Template For Windows 11 AVD 23h2 with Office 365
...
Download Citrix Virtual Delivery Agent 2507 and upload it to storage account for download during installation process.
...
"image_name" : prefix of name of the image and snapshot that will be used in capturing image. default value is "win_office_11_23h2" 
...
```shell
> .\packer.exe build .\win_office_11_23h2_packer_template.json
```
