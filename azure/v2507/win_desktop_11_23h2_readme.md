# Packer Template For Windows 11 PRO 23h2
...
"image_name" : prefix of name of the image and snapshot that will be used in capturing image. default value is "win_desktop_11_23h2" 
...
```shell
> .\packer.exe build .\win_desktop_11_23h2_packer_template.json
```
