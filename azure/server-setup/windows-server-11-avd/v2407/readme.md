# Packer Template For Windows 11 AVD 22H2
...
"image_name" : prefix of name of the image and snapshot that will be used in caputring image. default value is "win_server_11_22h2" 
...
```shell
> .\packer.exe build .\win_server_11_22h2_packer_template.json
```
