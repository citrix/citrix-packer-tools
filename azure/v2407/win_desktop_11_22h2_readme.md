# Packer Template For Windows 11 PRO 22H2
...
"image_name" : prefix of name of the image and snapshot that will be used in capturing image. default value is "win_desktop_11_22h2" 
...
```shell
> .\packer.exe build .\win_desktop_11_22h2_packer_template.json
```
